...
<div>
    ...
    <div class="fixed inset-0 flex z-40 md:hidden" role="dialog" aria-modal="true">
        ...
        <div class="relative flex-1 flex flex-col max-w-xs w-full pt-5 pb-4 bg-white">
            ...
            <div class="flex-shrink-0 flex items-center px-4">
                <img class="h-8 w-auto" src="{{ asset('imgz/Akros_web_dark.png') }}" alt="Workflow">
            </div>
    ...
    <div class="hidden md:flex md:w-64 md:flex-col md:fixed md:inset-y-0">
        ...
        <div class="flex flex-col flex-grow border-r border-gray-200 pt-5 bg-bg_light overflow-y-auto">
            <div class="mt-5"></div>
            <div class="flex items-center flex-shrink-0 px-4 relative">
                <div class="flex flex-col items-center h-[90px]">
                    <img class="h-12 w-auto" src="{{ asset('imgz/Akros_web_dark.png') }}" alt="Workflow">
                </div>
            </div>
            <div class="flex-grow flex flex-col">
                <nav class="flex-1 px-2 pb-4 space-y-1">
                    <!-- Current: "bg-gray-100 text-gray-900", Default: "text-gray-600 hover:bg-gray-50 hover:text-gray-900" -->
                    <a href="#" class="bg-white text-green-800 group flex items-center px-2 py-2 text-sm font-medium rounded-md space-x-2">
                        <!--
                          Heroicon name: outline/home
                    ...
                    <a href="#" class="space-x-2 text-gray-600 hover:bg-gray-50 hover:text-gray-900 group flex items-center px-2 py-2 text-sm font-medium rounded-md space-x-2">
                        <!-- Heroicon name: outline/users -->
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="#00d050"><path d="M24 11.7c0 6.45-5.27 11.68-11.78 11.68-2.07 0-4-.53-5.7-1.45L0 24l2.13-6.27a11.57 11.57 0 0 1-1.7-6.04C.44 5.23 5.72 0 12.23 0 18.72 0 24 5.23 24 11.7M12.22 1.85c-5.46 0-9.9 4.41-9.9 9.83 0 2.15.7 4.14 1.88 5.76L2.96 21.1l3.8-1.2a9.9 9.9 0 0 0 5.46 1.62c5.46 0 9.9-4.4 9.9-9.83a9.88 9.88 0 0 0-9.9-9.83m5.95 12.52c-.08-.12-.27-.19-.56-.33-.28-.14-1.7-.84-1.97-.93-.26-.1-.46-.15-.65.14-.2.29-.75.93-.91 1.12-.17.2-.34.22-.63.08-.29-.15-1.22-.45-2.32-1.43a8.64 8.64 0 0 1-1.6-1.98c-.18-.29-.03-.44.12-.58.13-.13.29-.34.43-.5.15-.17.2-.3.29-.48.1-.2.05-.36-.02-.5-.08-.15-.65-1.56-.9-2.13-.24-.58-.48-.48-.64-.48-.17 0-.37-.03-.56-.03-.2 0-.5.08-.77.36-.26.29-1 .98-1 2.4 0 1.4 1.03 2.76 1.17 2.96.14.19 2 3.17 4.93 4.32 2.94 1.15 2.94.77 3.47.72.53-.05 1.7-.7 1.95-1.36.24-.67.24-1.25.17-1.37"/></svg>
                        <span>WhatsApp</span>
                    </a>

                    <a href="#" class="space-x-2 text-gray-600 hover:bg-gray-50 hover:text-gray-900 group flex items-center px-2 py-2 text-sm font-medium rounded-md">
                        <!-- Heroicon name: outline/folder -->
                    ...
                    <div class="bg-white rounded">
                        <div class="flex flex-row items-center space-x-1 text-green-800 ml-4 py-1">
                            <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 9l6 6-6 6"/><path d="M4 4v7a4 4 0 0 0 4 4h11"/></svg>
                            <span>Users</span>
                        </div>
                        <div class="flex flex-row items-center space-x-1 text-green-800 ml-4 py-1">
                            <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 9l6 6-6 6"/><path d="M4 4v7a4 4 0 0 0 4 4h11"/></svg>
